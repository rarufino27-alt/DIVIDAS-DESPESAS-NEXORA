# Gestão financeira NEXORA V1.14 — Finalização UX
...
- V1.14 preparada para hardening de RLS.

## Supabase
Execute `05_supabase_security_hardening.sql` depois de `04_auth_phone_login.sql`.

A V1.14 ainda usa `app_state` como sincronização do estado do aplicativo. As tabelas normalizadas permanecem preparadas para a migração final, que será feita depois de validarmos a UX.
